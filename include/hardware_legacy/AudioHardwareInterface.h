...
public:
     ...
     */
    virtual status_t    setMasterVolume(float volume) = 0; // 24 (16)
     ...
     */
    virtual status_t    setMode(int mode) = 0; // 28 (20)

    virtual status_t    unknownA();

    // mic mute
    virtual status_t    setMicMute(bool state) = 0; // 36 (24)
