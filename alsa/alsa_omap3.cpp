...
static status_t s_init(alsa_device_t *module, ALSAHandleList &list)
{
    ...
    control.set("PredriveL Mixer AudioL1", 1);
    control.set("PredriveL Mixer AudioL2", 1);
    control.set("PredriveL Mixer AudioR2", 1);
    control.set("PredriveL Mixer Voice", 1);
    control.set("PredriveR Mixer AudioL2", 1);
    control.set("PredriveR Mixer AudioR1", 1);
    control.set("PredriveR Mixer AudioR2", 1);
    control.set("PredriveR Mixer Voice", 1);
#endif
